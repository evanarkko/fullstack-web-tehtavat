    ...
    render() {
        ...
        return (
            <div>
                ...
                <div>
                <Menu/>
                <Notification notification={this.state.notification}/>{this.state.user.name} logged in
                ...
                <Togglable buttonLabel='uusi blogi'>
                    ...
                    />
                        ...
                        <Route path="/users" render={() => <Users users={this.state.allUsers}/>} />
                        <Route path="/users/:id" render={({match}) =>
                            <User
                            user={this.state.allUsers.find(user => user._id === match.params.id)}/>}/>
